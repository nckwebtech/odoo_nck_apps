...
class BuyerStatementReport(models.AbstractModel):
    _name = 'report.nck_buyer_statements.report_buyer_statements'
...
class BuyerFilterStatementReport(models.AbstractModel):
    _name = 'report.nck_buyer_statements.report_buyer_filtered_statements'
...
class BuyerOverdueStatementReport(models.AbstractModel):
    _name = 'report.nck_buyer_statements.report_buyer_overdue_statements'
...
class SupplierCommonReport(models.AbstractModel):
    _name = 'report.nck_buyer_statements.report_supplier_filtered_statements'
...
class BuyerMonthlyReport(models.AbstractModel):
    _name = 'report.nck_buyer_statements.report_buyer_monthly_statements'
...
class BuyerWeeklyReport(models.AbstractModel):
    _name = 'report.nck_buyer_statements.report_buyer_weekly_statements'
...
class BuyerCustomReport(models.AbstractModel):
    _name = 'report.nck_buyer_statements.report_buyer_custom_statements'
