...
class PartnerData(models.TransientModel):
    ...
    def action_sent_buyer_mail_from_wizard(self):
        if self.email:
            template = self.env.ref('nck_buyer_statements.buyer_statement_email_template')
    ...
    def action_sent_buyer_overdue_mail_from_wizard(self):
        if self.email:
            template = self.env.ref('nck_buyer_statements.buyer_overdue_statement_email_template')
    ...
    def action_sent_filtered_buyer_statement_from_wizard(self):
        if self.email:
            template = self.env.ref('nck_buyer_statements.buyer_filtered_statement_email_template')
